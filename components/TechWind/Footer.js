...
function Footer() {
  return (
    <div className='bg-gray-900 mt-6'>
        {/* <!-- Footer Start --> */}
<footer class="footer bg-dark-footer relative text-gray-200 dark:text-gray-200 lg:ml-96 px-10 ">    
    <div class="w-[60%] md:w-[50%] lg:w-[65%]">
                    ...
                    <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px] ">
                        <div class="lg:col-span-4 md:col-span-12">
                            <a href="#" class="text-[22px] focus:outline-none">
                                <img src="/images/pro.png" alt="" className='w-[30px] '/>
                            </a>
                            <p class="mt-6 text-gray-300">As a full-stack developer, they are proficient in front-end technologies such as HTML, CSS, and JavaScript, which are used to create the user interface and ensure a seamless user experience. </p>
                                ...
                                <div class="grid grid-cols-1">
                                    <div class="foot-subscribe my-3">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input type="email" class="form-input bg-gray-800 border border-gray-800 text-gray-100 pl-12 py-1 focus:shadow-none rounded-md" placeholder="Email" name="email" required=""/>
                                        </div>
                                    </div>
                                        
                                    <button type="submit" id="submitsubscribe" name="send" class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-500 
               rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">Subscribe</button>
                                </div>
                            </form>
                        </div>
                        {/* <!--end col--> */}
        ...
        <div class="container text-center">
            <div class="grid md:grid-cols-2 items-center">
                <div class="md:text-left text-center">
                    <p class="mb-0"> 2023 Shawon Portfolio. </p>
                </div>
