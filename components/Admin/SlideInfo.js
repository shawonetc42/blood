...
function Slideinfo({post,modal=false}) {
  return (
   <>
{post?
 ...
 border-gray-200 rounded-lg shadow cursor-pointer
  dark:bg-gray-800 dark:border-gray-700 ">
    ...
    text-gray-900 dark:text-white">
      ...
      {modal? 
     <div>
      <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Read more
